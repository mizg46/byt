...
async def main():
    # TODO 修改user_id
    _user_id = '2ebQLwJvVUPcSFlLNlN3HzNKCaE'
    # TODO 修改代理列表
    socks5_proxy_list = [
        ...
        'http://15101226-zone-custom-region-DE-sessid-J7zIrIz5:MQww6IHb@us.922s5.net:6300',
        'http://15101226-zone-custom-region-DE-sessid-Ge6O8OP7:MQww6IHb@us.922s5.net:6300',
        'http://15101226-zone-custom-region-DE-sessid-djhd4hz4:MQww6IHb@us.922s5.net:6300',
